...
public interface IBabelSharedImages {
	...
	public static final String IMAGE_MINUS = "minus.gif"; //$NON-NLS-1$"    
	public static final String IMAGE_PLUS = "plus.gif"; //$NON-NLS-1$

	public static final String IMAGE_SIMILAR = "similar.gif"; //$NON-NLS-1$
